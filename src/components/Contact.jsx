      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="reveal-on-scroll grid sm:grid-cols-3 gap-4 mb-12">
          {contactCards.map((card) => {
            const content = (
              <>
                <div className="w-10 h-10 rounded-xl bg-pearl/[0.04] border border-pearl/[0.06] flex items-center justify-center text-pearl/60 group-hover:text-pearl transition-colors duration-300 mb-3">
          ...
          <div className="reveal-on-scroll flex items-center justify-center gap-4 mt-12">
            {socials.map((s) => (
              <a
                ...
                aria-label={s.label}
                className="w-11 h-11 rounded-full bg-pearl/[0.04] border border-pearl/[0.06] flex items-center justify-center text-mist hover:text-pearl hover:border-pearl/20 hover:bg-ash/60 transition-all duration-300"
              >
